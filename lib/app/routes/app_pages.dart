...
import '../modules/meal_list/bindings/meal_list_binding.dart';
import '../modules/meal_list/views/meal_list_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.MEAL_LIST,
      page: () => const MealListView(),
      binding: MealListBinding(),
    ),
  ];
}
